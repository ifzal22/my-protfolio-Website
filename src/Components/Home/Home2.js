  ...
  return (
    <div>
      ...
      <section className="home" id="home">
        ...
        <span>
          <span className="m-2">
            <a href={resume} download="Ifzal_Resume">
          ...
          <span>
            <a
              href="https://www.linkedin.com/in/ifzal-hussain-576376230/"
              rel="noreferrer noopener"
              target="_blank"
            >
              <button className="btn">
                Linke-din<i className="fab fa-linkedin p-2"></i>
              </button>
            </a>
          </span>
          <span className="m-2">
            <a
              href="https://github.com/ifzal22"
              rel="noreferrer noopener"
              target="_blank"
            >
              <button className="btn">
